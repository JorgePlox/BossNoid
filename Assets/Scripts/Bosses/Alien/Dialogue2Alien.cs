...
public class Dialogue2Alien : StateMachineBehaviour
{
    DialogueTrigger alien;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        alien = GameObject.Find("Alien").GetComponent<DialogueTrigger>();
        alien.TriggerDialogue();

        if (!BGMManager.isFading)
        {
